...
public class RoutingMain {
	...
	public static void main(String[] args) {
		Netzwerk net = new Netzwerk(new IPAdresse("192.168.0.128"),new IPAdresse("26"));
		Router router = new Router();
		
		router.routeAdd(new Route(new Netzwerk(new IPAdresse("192.168.0.0"),new IPAdresse("26")),1,new IPAdresse("190.2.2.1")));
		...
		System.out.println(router.longestPrefMatch((new IPAdresse("192.168.0.1"))));
